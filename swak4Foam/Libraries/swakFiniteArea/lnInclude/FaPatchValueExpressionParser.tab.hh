...
/**
 ** \file FaPatchValueExpressionParser.tab.hh
 ** Define the parserFaPatch::parser class.
 */
...
#ifndef YY_PARSERFAPATCH_FAPATCHVALUEEXPRESSIONPARSER_TAB_HH_INCLUDED
# define YY_PARSERFAPATCH_FAPATCHVALUEEXPRESSIONPARSER_TAB_HH_INCLUDED
...
# define YY_CONSTEXPR
#endif
# include "FaPatchValueExpressionParser_location.hh"
...
/* Debug traces.  */
#ifndef PARSERFAPATCHDEBUG
# if defined YYDEBUG
#if YYDEBUG
#   define PARSERFAPATCHDEBUG 1
#  else
#   define PARSERFAPATCHDEBUG 0
#  endif
# else /* ! defined YYDEBUG */
#  define PARSERFAPATCHDEBUG 1
# endif /* ! defined YYDEBUG */
#endif  /* ! defined PARSERFAPATCHDEBUG */

namespace parserFaPatch {
#line 164 "FaPatchValueExpressionParser.tab.hh"
  ...
  {
  public:
#ifndef PARSERFAPATCHSTYPE
    /// Symbol semantic values.
    union semantic_type
    {
#line 89 "../FaPatchValueExpressionParser.yy"
...
#line 190 "FaPatchValueExpressionParser.tab.hh"

    };
#else
    typedef PARSERFAPATCHSTYPE semantic_type;
#endif
    /// Symbol locations.
    ...
    struct token
    {
      enum yytokentype
      {
        ...
        TOKEN_min = 378,
        TOKEN_max = 379,
        TOKEN_minPosition = 380,
        TOKEN_maxPosition = 381,
        TOKEN_average = 382,
        TOKEN_sum = 383,
        TOKEN_sqr = 384,
        TOKEN_sqrt = 385,
    ...
    FaPatchValueExpressionParser (void * scanner_yyarg, FaPatchValueExpressionDriver& driver_yyarg, int start_token_yyarg, int numberOfFunctionChars_yyarg);
    virtual ~FaPatchValueExpressionParser ();
  ...
  private:
    ...
    FaPatchValueExpressionParser (const FaPatchValueExpressionParser&);
    FaPatchValueExpressionParser& operator= (const FaPatchValueExpressionParser&);
  ...
  private:
    ...
    {
      yyeof_ = 0,
      yylast_ = 5618,     ///< Last index in yytable_.
      yynnts_ = 39,  ///< Number of nonterminal symbols.
      yyfinal_ = 309, ///< Termination state number.
      yyterror_ = 1,
      yyerrcode_ = 256,
    ...
    // User arguments.
    void * scanner;
    FaPatchValueExpressionDriver& driver;
    int start_token;
...
#line 867 "FaPatchValueExpressionParser.tab.hh"





#endif // !YY_PARSERFAPATCH_FAPATCHVALUEEXPRESSIONPARSER_TAB_HH_INCLUDED
