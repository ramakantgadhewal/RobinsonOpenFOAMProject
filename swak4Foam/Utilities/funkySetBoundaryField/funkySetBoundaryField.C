...
Contributors/Copyright:
    2010, 2012-2014, 2016, 2018, 2020 Bernhard F.W. Gschaider <bgschaid@hfd-research.com>
    ...
    forAll(timeDirs, timeI)
    {
        ...
        forAllIter(dictionary,funkyDict,it) {
            ...
            forAll(expressions,expressionI) {
                ...
                word target(expression.lookup("target"));
                word patchName(expression.lookup("patchName"));
                exprString expr(
